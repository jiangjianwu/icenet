...
def resnet50_v1s(pretrained=False, nclass =1000, root=os.path.expanduser('~')+"/.torch/models", **kwargs):
    model = ResNetV1b(BottleneckV1b, [3, 4, 6, 3], num_classes=nclass, deep_stem=True, **kwargs)
    if pretrained:
